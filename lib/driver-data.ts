...
export const DRIVER_DATA: DriverEntry[] = [
  ...
  { id: "33", name: "SMI33", status: "active", truckType: "6 wheeler", priority: 1 },
  { id: "36", name: "SMI36", status: "active", truckType: "Triaxle", priority: 0 },
  { id: "38", name: "SMI38", status: "active", truckType: "Triaxle", priority: 0 },
  { id: "40", name: "SMI40", status: "active", truckType: "Triaxle", priority: 1 },
  { id: "41", name: "SMI41", status: "active", truckType: "Triaxle", priority: 1 },
  ...
  { id: "46", name: "SMI46", status: "active", truckType: "6 Wheeler", priority: 2 },
  ...
  { id: "68", name: "Mixer Driver", status: "active", truckType: "Conveyor", priority: 1 },
  { id: "69", name: "Mixer Driver", status: "active", truckType: "Mixer", priority: 2 },
  { id: "70", name: "Mixer Driver", status: "active", truckType: "Mixer", priority: 0 },
  { id: "71", name: "Mixer Driver", status: "active", truckType: "Mixer", priority: 1 },
  { id: "72", name: "Mixer Driver", status: "active", truckType: "Mixer", priority: 2 },
  { id: "73", name: "Mixer Driver", status: "active", truckType: "Mixer", priority: 2 },
  ...
  { id: "92s", name: "SMI92", status: "active", truckType: "Slinger", priority: 1 },
  ...
  { id: "97S", name: "SMI97S", status: "active", truckType: "Trailer", priority: 1 },
   { id: "97", name: "SMI97", status: "active", truckType: "Trailer", priority: 1 },
  { id: "106", name: "SMI106", status: "active", truckType: "Trailer", priority: 0 },
  { id: "107", name: "SMI107", status: "active", truckType: "Trailer", priority: 1 },
  { id: "108", name: "SMI108", status: "active", truckType: "Trailer", priority: 0 },
  { id: "110", name: "SMI110", status: "active", truckType: "Trailer", priority: 1 },
  { id: "111", name: "SMI111", status: "active", truckType: "Trailer", priority: 0 },
  { id: "112", name: "SMI112", status: "active", truckType: "Trailer", priority: 1 },
  { id: "114", name: "SMI114", status: "active", truckType: "Trailer", priority: 1 },
